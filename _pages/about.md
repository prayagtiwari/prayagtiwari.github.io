...
👋 Hi! I’m **Prayag**, an Associate Professor in Machine Learning at **Halmstad University**, Sweden. 📚 Visit **[Google Scholar](https://scholar.google.it/citations?hl=en&user=sDnmJ_YAAAAJ&view_op=list_works&sortby=pubdate) (Citations: ∼18200, H-index: 64)** for my research publications.
...
- 📣 **[Feb 2026]** 1 paper accepted by  [CVPR 2026](https://openaccess.thecvf.com/content/CVPR2026/html/Wang_Streaming_Video_Crime_Anticipation_with_Spatio-Temporal_Causal_Reasoning_CVPR_2026_paper.html)
...
- 📌 Yao B, Li Q, Zhang Y, Yang S, Zhang B, **Tiwari P**, Qin J. [NurValues: Real-World Nursing Values Evaluation for Large Language Models in Clinical Context](https://openreview.net/forum?id=ZTAvANYFL5).  **ICLR 2026**.
